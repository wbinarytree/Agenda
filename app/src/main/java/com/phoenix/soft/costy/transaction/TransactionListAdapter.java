...
public class TransactionListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    @Override public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ItemHolder) {
            ...
            if (money.toString().contains("-")) {
                ...
                itemHolder.tvNumber.setTextColor(
    ...
    static class ItemHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.tv_title_type) TextView tvTitle;
    ...
    class HeaderHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.tv_outcome) TextView tvOutcome;
        @BindView(R.id.tv_total) TextView tvTotal;
        @BindView(R.id.account_card) CardView cardView;
        @BindView(R.id.detail_chart) PieChart chart;
