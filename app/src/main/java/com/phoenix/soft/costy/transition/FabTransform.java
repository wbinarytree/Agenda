...
import com.phoenix.soft.costy.utils.AnimUtils;
...
public class FabTransform extends Transition {
    ...
    public FabTransform(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            if (!a.hasValue(R.styleable.FabTransform_fabColor) || !a.hasValue(
    ...
    public Animator createAnimator(final ViewGroup sceneRoot, final TransitionValues startValues,
                ...
                @Override public void onAnimationEnd(Animator animation) {
                    view.setOutlineProvider(new ViewOutlineProvider() {
                        @Override public void getOutline(View view, Outline outline) {
                            ...
                            outline.setOval(left, top, left + fabBounds.width(),
        ...
        final Animator translate =
            ObjectAnimator.ofFloat(view, View.TRANSLATION_X, View.TRANSLATION_Y,
