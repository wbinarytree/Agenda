...
public class TransactionFragment extends Fragment
    implements TransactionContract.View, MainActivity.FabClick {
    public final static String TAG = "DETAIL_FRAGMENT";
    private static final int REQUEST_CODE_DETAIL = 0xF1;
    @BindView(R.id.detail_list) RecyclerView detailRecyclerList;
    @BindView(R.id.container_no_trans) View noTransContainer;
    ...
    @Override public void showTransactionList() {
    ...
    @Override public void showAddDetailDialog() {
    ...
    @Override public void showNoTransaction() {
    ...
    @Override public void initTransactionList(List<Transaction> transactions) {
        transactionListAdapter = new TransactionListAdapter(transactions);
        LinearLayoutManager layout =
            new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false);
        detailRecyclerList.addItemDecoration(
        ...
        switch (requestCode) {
            case REQUEST_CODE_DETAIL:
                if (resultCode == RESULT_OK) {
                    ...
                    Money money = add ? Money.parse(account.getCurrency() + number)
